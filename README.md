a easy for game for worewolf, clients connect to local server, so if you want to try it on more than two different  computer, you need to change IP address by yourself.
server screen
